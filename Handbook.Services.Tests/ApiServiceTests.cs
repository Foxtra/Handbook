...
namespace Handbook.Services.Tests
{
    ...
    {
        [Fact(DisplayName = "Позитивный сценарий загрузки цилиндров")]
        ...
        [Fact(DisplayName = "Сценарий с отсутствие элементов")]
        ...
        [Fact (DisplayName = "Сценарий при котором API отвечает ошибкой 404")]
        ...
        [Fact(DisplayName = "Сценарий невалидного формата JSON")]
        ...
        [Fact(DisplayName = "Сценарий большого количества элементов")]
